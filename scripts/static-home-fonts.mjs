...
const faces = [
  ...
  ["Manrope", "manrope-vietnamese.bab757f8a0a1bc04.woff2", "bab757f8a0a1bc04", "U+102-103,U+110-111,U+128-129,U+168-169,U+1A0-1A1,U+1AF-1B0,U+300-301,U+303-304,U+308-309,U+323,U+329,U+1EA0-1EF9,U+20AB"],
...
export function verifyStaticHomeFonts() {
  for (const [, file, hash] of faces) {
    const path = join(fontRoot, file);
